...
class Test_bank(unittest.TestCase):
    ...
    text_date = 'web.cbr.ru/"><GetC7463764583756sult><Val@#$#%#^$& OnDate="20220623" xmlns=""><Австралийский доллар'
    result_text_date = '20220623'
    
    def test_get_date(self, data = text_date, result = result_text_date ):
        self.assertEqual(df.get_date(data), result)
    ...
    def test_get_data_list_xml(self, data = text_list_xml, result = result_text_list_xml ):
        self.assertEqual(df.get_data_list_xml(data), result)
